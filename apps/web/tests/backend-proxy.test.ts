    ...
    async (input, init) => {
      ...
      if (url.pathname === "/metrics") {
        return json({
          ...
          paidTasksStatus: "requires_complete_deal_evidence_coverage",
          ...
          grossMarginStatus: "requires_complete_deal_evidence_coverage",
          revenueClassification: "incomplete_deal_evidence_coverage",
          dealEvidenceCount: 1,
          usersAcquired: 1,
          payingUsers: 0,
